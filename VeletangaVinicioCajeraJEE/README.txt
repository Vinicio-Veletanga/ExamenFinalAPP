...
a persistence unit "VeletangaVinicioCajeraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "VeletangaVinicioCajeraJEE\pom.xml":
...
artifact ("VeletangaVinicioCajeraJEE.war") is already built. You can build
