...
a persistence unit "VeletangaVinicioSRIJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "VeletangaVinicioSRIJEE\pom.xml":
...
artifact ("VeletangaVinicioSRIJEE.war") is already built. You can build
