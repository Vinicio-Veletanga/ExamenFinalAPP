...
a persistence unit "VeletangaVinicioOperadoraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "VeletangaVinicioOperadoraJEE\pom.xml":
...
artifact ("VeletangaVinicioOperadoraJEE.war") is already built. You can build
